...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJ1YmFrci1tdWhhbW1hZCIsImEiOiJjanl2OXl6cmowOGlpM2VwbThqZTY3dHh3In0.U9D27pUAS816bk5Mfgw-0g';
...
function _updateSettings() {
  _updateSettings = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            response = _context.sent;
            if (response.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfully!"));
            _context.next = 11;
            break;
...
/* eslint-disable */
var stripe = Stripe('pk_test_sb8AA9PvCMl18KcJE0sUtZzD00J20dHRh4');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            password = document.getElementById('password').value;
            _context2.next = 6;
            return (0, _account.login)(email, password);
...
if (bookButton) bookButton.addEventListener('click',
/*#__PURE__*/
function () {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3598" + '/');
